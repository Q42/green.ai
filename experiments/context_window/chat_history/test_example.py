...
async def test_base(evaluate_test_case, debug_mode, settings, metadata):
...
@pytest.mark.asyncio
@pytest.mark.experiment
async def test_cutoff(evaluate_test_case, debug_mode, settings, metadata):
...
@pytest.mark.asyncio
@pytest.mark.experiment
async def test_smart_cutoff(evaluate_test_case, debug_mode, settings, metadata):
